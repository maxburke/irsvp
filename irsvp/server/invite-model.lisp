...
(defclass invite ()
 ((id :col-type serial :initarg :id :reader invite-id)
  ...
  (responded :col-type integer :col-default -1 :initarg :responded :accessor invite-responded)
  (num-guests :col-type integer :col-default 1 :initarg :num-guests :accessor invite-num-guests))
 (:metaclass dao-class)
 (:keys id)
)
